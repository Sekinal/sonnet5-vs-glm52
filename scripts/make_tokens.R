...
# max effort). Sonnet 5 cost-to-run is now AA-measured ($6,015 at standard $3/$15).
...
title_block <- ggplot() + theme_void() +
  labs(title = "Is GLM 5.2 really cheaper? Yes, and by a lot",
       subtitle = paste0(
...
caption_block <- ggplot() + theme_void() +
  labs(title = "<span style='color:#8a8178'>Source: Artificial Analysis, output tokens and measured cost to run Intelligence Index v4.1 at max reasoning effort (Sonnet 5 $6,015, Opus 4.8 $3,753, GPT-5.5 $2,819, GLM 5.2 $933, Gemini 3.1 Pro $815; field-avg ~37M tokens). Sonnet 5 measured at standard $3/$15 (intro $2/$10 through Aug 31 is ~$4,010). Sticker output prices per 1M: Sonnet 5 $15, GLM 5.2 $4.40, Opus 4.8 $25. Built with R and the tidyverse.</span>") +
